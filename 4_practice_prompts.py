...
item2 = "Mouse"
item3 = "Bookbag"
message = f"There is three items in our computer room. The items are {item1}, {item2} and {item3}."
print(message)
...
date = "11/7/25"
print(date)
movie_name = "Pursuit of Happyness"
print(movie_name)
...
print(f"You're learning {learn} today.")
...
print(f"You are {name} and your favorite color is {color}.")
